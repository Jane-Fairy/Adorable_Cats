...
func (m *defaultGoodsCategoryModel) Insert(ctx context.Context, data *GoodsCategory) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.CategoryId, data.Name, data.ParentId, data.ImageId, data.Sort)
	return ret, err
}
...
func (m *defaultGoodsCategoryModel) Update(ctx context.Context, data *GoodsCategory) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, data.Name, data.ParentId, data.ImageId, data.Sort, data.CategoryId)
	return err
}
