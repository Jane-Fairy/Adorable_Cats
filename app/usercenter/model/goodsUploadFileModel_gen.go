...
func (m *defaultGoodsUploadFileModel) Insert(ctx context.Context, data *GoodsUploadFile) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.FileId, data.Storage, data.FileUrl, data.FileName, data.FileSize, data.FileType, data.Extension, data.IsUser, data.IsRecycle, data.IsDelete)
	return ret, err
}
...
func (m *defaultGoodsUploadFileModel) Update(ctx context.Context, data *GoodsUploadFile) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, data.Storage, data.FileUrl, data.FileName, data.FileSize, data.FileType, data.Extension, data.IsUser, data.IsRecycle, data.IsDelete, data.FileId)
	return err
}
