...
func (m *defaultGoodsModel) Insert(ctx context.Context, data *Goods) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.GoodsId, data.GoodsName, data.SellingPoint, data.CategoryId, data.DeductStockType, data.Content, data.SalesInitial, data.SalesActual, data.GoodsSort, data.GoodsStatus, data.IsDelete)
	return ret, err
}
...
func (m *defaultGoodsModel) Update(ctx context.Context, data *Goods) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, data.GoodsName, data.SellingPoint, data.CategoryId, data.DeductStockType, data.Content, data.SalesInitial, data.SalesActual, data.GoodsSort, data.GoodsStatus, data.IsDelete, data.GoodsId)
	return err
}
