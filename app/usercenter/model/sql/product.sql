...
CREATE TABLE goods
(
    goods_id          VARCHAR(255) PRIMARY KEY COMMENT '商品id',
  ...
  DEFAULT CHARSET = utf8 COMMENT ='商品记录表';

DROP TABLE IF EXISTS `goods_category`;
CREATE TABLE `goods_category`
(
    `category_id` VARCHAR(255) PRIMARY KEY COMMENT '商品分类id',
...
(
    file_id     VARCHAR(255) PRIMARY KEY COMMENT '文件id',
  ...
  DEFAULT CHARSET = utf8 COMMENT ='图片记录表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='商品图片记录表';

DROP TABLE IF EXISTS `goods_spec`;
CREATE TABLE goods_spec
(
    spec_id     VARCHAR(255) PRIMARY KEY COMMENT '规格组id',
    spec_name   varchar(255) NOT NULL DEFAULT '' COMMENT '规格组名称',
    create_time int(11)      NOT NULL COMMENT '创建时间'
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8 COMMENT ='商品规格组记录表';


DROP TABLE IF EXISTS `goods_sku`;
CREATE TABLE goods_sku
(
    goods_sku_id VARCHAR(255) PRIMARY KEY COMMENT '商品规格id',
    goods_id     int(11) UNSIGNED        NOT NULL DEFAULT '0' COMMENT '商品id',
...
(
    spec_value_id VARCHAR(255) PRIMARY KEY COMMENT '规格值id',
    spec_value    varchar(255) NOT NULL COMMENT '规格值',
    spec_id       int(11)      NOT NULL COMMENT '规格组id',
    create_time   int(11)      NOT NULL COMMENT '创建时间'
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8 COMMENT ='商品规格值记录表';