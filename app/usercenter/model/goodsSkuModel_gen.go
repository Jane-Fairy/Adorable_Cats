...
func (m *defaultGoodsSkuModel) Insert(ctx context.Context, data *GoodsSku) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.GoodsSkuId, data.GoodsId, data.SpecSkuId, data.ImageId, data.GoodsNo, data.GoodsPrice, data.LinePrice, data.StockNum, data.GoodsSales, data.GoodsWeight, data.DeleteTime, data.DelState)
	return ret, err
}
...
func (m *defaultGoodsSkuModel) Update(ctx context.Context, data *GoodsSku) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, data.GoodsId, data.SpecSkuId, data.ImageId, data.GoodsNo, data.GoodsPrice, data.LinePrice, data.StockNum, data.GoodsSales, data.GoodsWeight, data.DeleteTime, data.DelState, data.GoodsSkuId)
	return err
}
